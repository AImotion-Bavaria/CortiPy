"""Convert BIN -> SBIDS and run P300 evaluation."""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--no-plots",
        action="store_true",
        help="Disable matplotlib plots during P300 evaluation.",
    )
    return parser
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    evaluation = ds.evaluate_p300(show_plots=not args.no_plots)
    summary = _summarize_evaluation(evaluation)
    print("P300 evaluation completed. Summary:")
