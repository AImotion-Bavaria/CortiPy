"""Convert BIN -> SBIDS and run ASSR evaluation."""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--no-plots",
        action="store_true",
        help="Disable matplotlib plots during ASSR evaluation.",
    )
    return parser
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    evaluation = ds.evaluate_assr(show_plots=not args.no_plots)
    summary = _summarize_evaluation(evaluation)
    print("ASSR evaluation completed. Summary:")
