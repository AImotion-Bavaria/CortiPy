"""Convert BIN -> SBIDS and run VEP evaluation."""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--no-plots",
        action="store_true",
        help="Disable matplotlib plots during VEP evaluation.",
    )
    return parser
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    evaluation = ds.evaluate_vep(show_plots=not args.no_plots)
    summary = _summarize_evaluation(evaluation)
    print("VEP evaluation completed. Summary:")
