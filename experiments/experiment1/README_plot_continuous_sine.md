...
- Default dataset directory: `experiments/datasets/D2_software_curated_signals/ContinuousSine/`
...
## How to run
```bash
python experiments/experiment1/plot_continuous_sine.py
python experiments/experiment1/plot_continuous_sine.py --seconds 5 --channel 3
```
