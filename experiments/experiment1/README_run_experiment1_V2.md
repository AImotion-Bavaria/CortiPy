...
6. Writes a JSON summary to `results/`.
...
![Oddball trace comparison](results/comparisons/Oddball_trace_comparison.png)
![VEP topomap comparison](results/comparisons/VEP_topomap_comparison.png)

## How to run
```bash
PYTHONPATH=. python experiments/experiment1/run_experiment1_V2.py
```
