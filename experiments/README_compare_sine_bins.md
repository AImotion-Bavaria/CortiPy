...
- `experiments/synData/ContinuousSine/EEGlab_erp_average.bin`
- `experiments/synData/ContinuousSine/EEGlab_psd_dB_continuous.bin`

Default CortiPy files:
- `experiments/format_benchmark/results_sine/bin/CortiPy_erp_average.bin`
- `experiments/format_benchmark/results_sine/bin/CortiPy_psd_dB.bin`
...
## How to run
```bash
python experiments/compare_sine_bins.py
python experiments/compare_sine_bins.py --split half --no-plot
```
