...
- **D1 – Random streaming matrices** (`experiments/datasets/D1_random_streaming_matrices/datasets.json`):
  - `rand1`: 19 channels @ 250 Hz, 1 hour
  - `rand2`: 64 channels @ 1000 Hz, 1 hour
  - `rand3`: 256 channels @ 2000 Hz, 1 hour
...
## Outputs and plots
Written under `experiments/experiment2/results/`:
...
![Size trend](results/size_trend.png)
![Read latency boxplot](results/latency_box_read.png)
![Read throughput](results/read_throughput_mb.png)

## How to run
```bash
PYTHONPATH=. python experiments/experiment2/run_experiment2.py
PYTHONPATH=. python experiments/experiment2/run_experiment2.py --containers bids --formats edf
PYTHONPATH=. python experiments/experiment2/run_experiment2.py --plots-only --results-json experiments/experiment2/results/experiment2_results.json
```
