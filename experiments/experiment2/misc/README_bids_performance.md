...
## How to run
```bash
python experiments/experiment2/misc/bids_performance.py /path/to/bids_root --subject 01 --task oddball
python experiments/experiment2/misc/bids_performance.py /path/to/bids_root --all-recordings --output results/bids_perf.json
```

## Related experiments
- [sbids_performance](README_sbids_performance.md) benchmarks SBIDS JSON-LD loading.
- [run_experiment2](../README_run_experiment2.md) measures write/read latency for exported BIDS formats.
