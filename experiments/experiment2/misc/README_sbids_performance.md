...
## How to run
```bash
python experiments/experiment2/misc/sbids_performance.py /path/to/recordings.jsonld --recording-id urn:recording:001
python experiments/experiment2/misc/sbids_performance.py /path/to/recordings.jsonld --all-recordings --data-root /data/raw
```

## Related experiments
- [bids_performance](README_bids_performance.md) benchmarks BIDS loading.
- [run_experiment2](../README_run_experiment2.md) measures write/read latency for SBIDS exports.
